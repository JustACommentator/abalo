...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ab_article', function (Blueprint $table) {
            ...
            $table->char('ab_desciption', 1000)->nullable(false)->comment('Beschreibung, die die Güte oder die Beschaffenheit näher darstellt. Wird durch den "Ersteller" (ab_user) gepflegt');
